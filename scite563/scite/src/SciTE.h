...
#define VERSION_SCITE "5.6.3"
#define VERSION_WORDS 5, 6, 3, 0
#define COPYRIGHT_DATES "December 1998-June 2026"
#define COPYRIGHT_YEARS "1998-2026"
#define VERSION_SCINTILLA "5.6.3"
#define VERSION_LEXILLA "5.5.0"
